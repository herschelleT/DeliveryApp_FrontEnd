...
public class FreshFood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowdialog6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(FreshFood.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.SelectNumber));
    ...
    public void function(Button button,String string){
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(FreshFood.this);
