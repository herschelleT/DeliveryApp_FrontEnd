...
public class Lifestyle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        function(mShowDialog,"Pen");
        mShowDialog1 = (Button) findViewById(R.id.number1);
        function(mShowDialog1,"Scissors");
        mShowDialog2 = (Button) findViewById(R.id.number2);
        function(mShowDialog2,"Geometry-box");
        mShowDialog3 = (Button) findViewById(R.id.number3);
        function(mShowDialog3,"brush");
        mShowDialog4 = (Button) findViewById(R.id.number4);
        function(mShowDialog4,"Pencil");
        mShowDialog5 = (Button) findViewById(R.id.number5);
        function(mShowDialog5,"Marker");Button mShowdialog6 = (Button) findViewById(R.id.Other);
        mShowdialog6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder myDialog=new AlertDialog.Builder(Lifestyle.this);
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(Lifestyle.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.SelectNumber));
        ...
        });//An option for users who have to other smthg else*/
    }
    public void function(Button button,String string){
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Lifestyle.this);
    ...
    }//the function of button tht is pressed to place the order
}